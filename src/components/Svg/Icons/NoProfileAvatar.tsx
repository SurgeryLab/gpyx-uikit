...
const Icon: React.FC<SvgProps> = (props) => {
  ...
  const primaryColor = theme.isDark ? "#272D32" : "#e9eaeb";
  // const secondaryColor = theme.isDark ? "#666171" : "#bdc2c4";

  return (
    <Svg viewBox="0 0 36 36" {...props}>
      <rect width="36" height="36" rx="18" fill={primaryColor} />
      <mask id="A" mask-type="alpha" maskUnits="userSpaceOnUse" x="10" y="7" width="16" height="32">
        <path d="M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16z" fill="#c4c4c4" />
      </mask>
      <g mask="url(#A)">
        <path d="M10 18L18 7L26 18L18 29L10 18Z" fill="#545E66"/>
        {/* <path */}
